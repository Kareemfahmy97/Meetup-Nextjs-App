...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://kareemfahmyy:0125156522KkKk@cluster0.3itc3tp.mongodb.net/Meetups?retryWrites=true&w=majority");
  const db = client.db();
